...
<body>
  ...
  if(isset($_POST['submit']))
  {
    ...
    $room=$_POST['room'];
    $remark=$_POST['remark'];
    $sql=$con->query("UPDATE table_name SET asset_name = '$name', year= '$year',current_department='$department',quantity='$quantity',inventory_no='$inventory',block='$block',floor='$floor',room='$room',remarks='$remark' WHERE s_no='$s_no'");
    if($sql)
    {
